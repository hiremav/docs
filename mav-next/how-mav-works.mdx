...
<Steps>
  ...
  <Step title="The agent engages over text">
  ...
  <Step title="It moves to voice when useful">
    When the contact is ready — or texts “call me” — the agent can place a [phone call](/mav-next/voice) and [transfer them live to a rep](/mav-next/rep-transfers), then return to text messaging afterward.
  </Step>
...
<Note>
  The agent remembers the entire history of a conversation, across both text and voice. Nothing is repeated or lost when a contact moves from texting to a call and back.
</Note>
